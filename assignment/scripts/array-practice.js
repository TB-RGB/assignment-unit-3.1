...
//**TB - I think I did this already in 3.b, so I will answer using the hardcoded index below**
lastAnimal = animalArray[3];
console.log(`Animals in array are: ${animalArray} and the last animal is : ${lastAnimal} (stretch)`);
...
gems.sort();
gems.reverse();
console.log(`Reverse alphabetical array: ${gems}`);
